...
if(battle == true)
{
	...
	if(playerTurn) && (!showBattleText)
	{
		...
		if (!showAttackOptions)//show attack options
		{
		...
		{
			//show different attacks for attack option
