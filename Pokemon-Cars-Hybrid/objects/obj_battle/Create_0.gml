...
a_item_text [0] = "NITROUS";
a_item_text [1] = "E-BRAKE";
a_item_text [2] = "ROBO MECHANIC";

global.playerHP = 100;
playerMAXHP = 100;

global.opponentHP = 10;
oppMAXHP = 100;

selected_option = 0; //which option is the arrow over
attack_option = 0;//option attack arrow is over
item_option = 0;//option item arrow is over
